...
pretrained_model_file = "/Users/alex/Downloads/td_torso_model.pth"
...
model_params = torch.load(pretrained_model_file)
...
state_dict[head_key] = torch.tile(state_dict[head_key], (1, 3, 1, 1)) / 3
