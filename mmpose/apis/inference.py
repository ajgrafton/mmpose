...
from mmpose.models.detectors.base import BaseFusionPose
...
def init_fusion_pose_model(config, checkpoint=None, device="cuda:0") -> BaseFusionPose:
    model: BaseFusionPose = init_pose_model(config, checkpoint, device)
    return model
